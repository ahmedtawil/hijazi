...
var KTCustomerInvoicesList = function () {
    ...
    var initCustomerInvoicesList = function () {
        ...
        datatable = $(table).DataTable({
            ...
            "ajax": {
                url: `/invoices/data/customer/get/${customerID}`,
                "dataSrc": 'invoices',
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-kt-customer-invoices-table-filter="search"]');
    ...
    var handleFilter = function () {
        ...
        const filterForm = document.querySelector('[data-kt-customer-invoices-table-filter="form"]');
        const filterButton = filterForm.querySelector('[data-kt-customer-invoices-table-filter="filter"]');
        const resetButton = filterForm.querySelector('[data-kt-customer-invoices-table-filter="reset"]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-kt-customer-invoices-table-filter="delete_row"]');
    ...
    return {
        ...
        init: function () {
            table = document.querySelector('#kt_customer_invoices_table');
